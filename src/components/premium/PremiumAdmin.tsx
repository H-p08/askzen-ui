...
import AutoPDFUploader from "../pdf/AutoPDFUploader";
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Manage premium features, PDFs & Telegram integration</p>
          </div>
        </div>
      </div>
      ...
      <Tabs defaultValue="settings" className="w-full">
        <TabsList className="grid w-full grid-cols-5">
          ...
          <TabsTrigger value="telegram-channel">Channel</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="auto-upload" className="mt-6">
          <AutoPDFUploader />
        </TabsContent>

        <TabsContent value="telegram-bot" className="mt-6">
          <TelegramBot />
        </TabsContent>

        <TabsContent value="telegram-channel" className="mt-6">
          <TelegramChannel />
        </TabsContent>
      </Tabs>
    </div>
